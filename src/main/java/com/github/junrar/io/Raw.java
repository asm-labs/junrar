...
public class Raw {
     ...
     */
    public static void writeShortBigEndian(byte[] array, int pos,
                                                 short value) {
     ...
     * @param value the value to write
     */
    public static void writeLongBigEndian(byte[] array, int pos,
                                                long value) {
     ...
     * @param value the value to write
     */
    public static void writeShortLittleEndian(byte[] array, int pos,
                                                    short value) {
     ...
     * @param value the value to write
     */
    public static void writeLongLittleEndian(byte[] array, int pos,
                                                   long value) {
